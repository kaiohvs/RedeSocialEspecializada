...
namespace RedeSocialEspecializada.Controllers
{
    public class GrupoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Desc,Categoria")] Grupo grupo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Desc,Categoria")] Grupo grupo)
        {
            if (id != grupo.Id)
            {
                return NotFound();
